...
// Adicionar evento para atualizar as tabelas quando mudar para a aba de configurações
document.getElementById('configLink').addEventListener('click', carregarTabelas);

// Adicionar event listeners aos formulários
document.querySelector('#formCidade').addEventListener('submit', cadastrarCidade);
